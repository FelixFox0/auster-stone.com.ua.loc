...
class ControllerCustomerCustomer extends Controller {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['fio']) < 1) || (utf8_strlen(trim($this->request->post['fio'])) > 132)) {
		...
		if (isset($this->request->post['address'])) {
			foreach ($this->request->post['address'] as $key => $value) {
				if ((utf8_strlen($value['fio']) < 1) || (utf8_strlen($value['fio']) > 100)) {
					$this->error['address'][$key]['fio'] = $this->language->get('error_fio');
				}
