<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $skidki; ?>"><?php echo $text_skidki; ?></a></li>
      <li><a href="<?php echo $recurring; ?>"><?php echo $text_recurring; ?></a></li>
      <li><a href="<?php echo $filter; ?>"><?php echo $text_filter; ?></a></li>
     <?php /* <li><a class="parent"><?php echo $text_attribute; ?></a>
        <ul>
      ...
      <li><a href="<?php echo $rubriki; ?>"><?php echo $text_rubriki; ?></a></li>
      <li><a href="<?php echo $galerys; ?>"><?php echo $text_galerys; ?></a></li>
    </ul>
  </li>
  ...
  <li    id="main_sett"><a class="parent"><i class="fa fa-cogs"></i> <span><?php echo $text_main_set; ?></span></a>
      <ul>
          <li><a href="<?php echo $text_header_set_viewed; ?>"><?php echo $text_header_set; ?></a></li>
        </ul>
  </li>
</ul>
