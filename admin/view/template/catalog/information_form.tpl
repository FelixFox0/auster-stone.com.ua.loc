        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-rubriki"><?php echo $entry_main_rubriki; ?></label>
                    <div class="col-sm-10">
                        <select id="input-rubriki" name="rubriki_id" class="form-control">
                            <option value="0" selected="selected"><?php echo $text_none; ?></option>
                            <?php foreach($rubriki as $category) { ?>
                                <?php if($category['rubriki_id'] == $rubriki_id) { ?>
                                        <option value="<?php echo $category['rubriki_id']; ?>" selected="selected"><?php echo $category['name']; ?></option>
                                <?php } else { ?>
                                        <option value="<?php echo $category['rubriki_id']; ?>"><?php echo $category['name']; ?></option>
                                <?php } ?>
                            <?php } ?>
                        </select>
                    </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom"><span data-toggle="tooltip" title="<?php echo $help_blog; ?>"><?php echo $help_blog; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($blog) { ?>
                      <input type="checkbox" name="blog" value="1" checked="checked" id="input-bottom" />
                      <?php } else { ?>
                      <input type="checkbox" name="blog" value="1" id="input-bottom" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
