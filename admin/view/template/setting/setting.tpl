        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-telephone1"><?php echo $entry_telephone; ?> 2</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_telephone1" value="<?php echo $config_telephone1; ?>" placeholder="<?php echo $entry_telephone; ?> 2" id="input-telephone1" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
