        ...
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-payment">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payment_address" id="input-payment-address" class="form-control">
                    ...
                    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['fio'] .  ', ' . $address['address_1'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-fio"><?php echo $entry_fio; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fio" value="<?php echo $payment_fio; ?>" id="input-payment-fio" class="form-control" />
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-shipping">
              <div class="form-group">
                ...
                <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-fio"><?php echo $entry_fio; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="fio" value="<?php echo $shipping_fio; ?>" id="input-shipping-fio" class="form-control" />
                </div>
              </div>
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#tab-customer input[name=\'fio\']').val(item['fio']);
		...
		for (i in  item['address']) {
			html += '<option value="' + item['address'][i]['address_id'] + '">' + item['address'][i]['fio'] + ', ' + item['address'][i]['address_1'] + ', ' + item['address'][i]['city'] + ', ' + item['address'][i]['country'] + '</option>';
		}
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-payment input[name=\'fio\']').val(json['fio']);
...
$('select[name=\'shipping_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-shipping input[name=\'fio\']').val(json['fio']);
