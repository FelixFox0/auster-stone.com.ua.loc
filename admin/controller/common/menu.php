...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_rubriki'] = $this->language->get('text_rubriki');
		$data['text_galerys'] = $this->language->get('text_galerys');
		...
		$data['text_main_set'] = $this->language->get('text_main_set');
		$data['text_header_set'] = $this->language->get('text_header_set');
		...
		$data['rubriki'] = $this->url->link('catalog/rubriki', 'token=' . $this->session->data['token'], 'SSL');
		$data['galerys'] = $this->url->link('catalog/galery', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['skidki'] = $this->url->link('catalog/skidki', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['text_header_set_viewed'] = $this->url->link('dispsett/header', 'token=' . $this->session->data['token'], 'SSL');
