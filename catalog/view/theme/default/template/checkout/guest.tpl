  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-fio"><?php echo $entry_fio; ?></label>
        <input type="text" name="fio" value="<?php echo $fio; ?>" placeholder="<?php echo $entry_fio; ?>" id="input-payment-fio" class="form-control" />
      </div>
