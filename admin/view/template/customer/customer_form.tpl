                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-fio<?php echo $address_row; ?>"><?php echo $entry_fio; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][fio]" value="<?php echo $address['fio']; ?>" placeholder="<?php echo $entry_fio; ?>" id="input-fio<?php echo $address_row; ?>" class="form-control" />
                          <?php if (isset($error_address[$address_row]['fio'])) { ?>
                          <div class="text-danger"><?php echo $error_address[$address_row]['fio']; ?></div>
                          <?php } ?>
                        </div>
                      </div>
...
function addAddress() {
	...
	html += '    <label class="col-sm-2 control-label" for="input-fio' + address_row + '"><?php echo $entry_fio; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][fio]" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-fio' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
