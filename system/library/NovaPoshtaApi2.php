...
class Novaposhtaapi2 {
	 ...
	 */
	function __construct($key = 'd75d9d83daf7b7b7480629bbf85152a3', $language = 'ru', $throwErrors = FALSE, $connectionType = 'curl') {
	...
	protected function findArea(array $areas, $findByString = '', $ref = '') {
        ...
        public function getAllAreas() {
            $areas = $this->areas = include dirname(__FILE__).'/NovaPoshtaApi2Areas.php';
            $arrs = array();
