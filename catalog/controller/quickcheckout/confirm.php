		...
		if (!$redirect) {
			...
			if ($this->customer->isLogged()) {
				...
				$order_data['customer_id'] = $this->customer->getId();
                                $order_data['fio'] = $customer_info['fio'];
				...
				$order_data['custom_field'] = unserialize($customer_info['custom_field']);
                                ...
                                $order_data['fio'] = $this->session->data['guest']['fio'];
				...
				$order_data['custom_field'] = $this->session->data['guest']['custom_field'];
                        ...
                        $order_data['payment_fio'] = $this->session->data['payment_address']['fio'];
...
//			$order_data['payment_lastname'] = $this->session->data['payment_address']['lastname'];
			...
			if ($this->cart->hasShipping()) {
                                $order_data['shipping_fio'] = $this->session->data['shipping_address']['fio'];
...
//				$order_data['shipping_lastname'] = $this->session->data['shipping_address']['lastname'];
				...
				foreach ($product['option'] as $option) {
					$option_data[] = array(
						...
						'type'                    => $option['type']
                                ...
                                $options_c = json_decode($product['options_c']);
                                if(isset($options_c->product_type)){
                                    $pr_n_type=$options_c->product_type;

                                unset($options_c->product_type);
                                }else{
                                    $pr_n_type=1;
                                }
				$order_data['products'][] = array(
			...
			if ($this->session->data['delivery_date'] != '') {
				$this->session->data['comment'] = "@@Delivery Date: " . $this->session->data['delivery_date'] . "\n" . $this->session->data['comment'];
                        ...
                        if(isset($this->session->data['shipping_method']['code']) && $this->session->data['shipping_method']['code']=='novayapochta.novayapochta'){
                            $this->session->data['comment'] = "@@" . $this->session->data['shipping_method']['title'] . ":\r\n";
                            $this->session->data['comment'] .= $this->session->data['shipping_method']['area']." область \r\n";
                           $this->session->data['comment'] .= "Город- ".$this->session->data['shipping_method']['city']. "\r\n";
                            $this->session->data['comment'] .= "Склад- ".$this->session->data['shipping_method']['sklad']. "\r\n";
                        }
