...
//                if (isset($this->session->data['payment_address']['fio'])) {
//			$data['fio'] = $this->session->data['payment_address']['fio'];
//		} else {
//			$fio = $this->config->get('quickcheckout_field_country');
//
//			$data['fio'] = $fio['default'];
//		}
//                var_dump($this->config->get('quickcheckout_field_country'));
