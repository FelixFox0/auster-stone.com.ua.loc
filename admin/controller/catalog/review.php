		...
		if (isset($this->request->post['product_id'])) {
			...
			$data['information_id'] = 0;
                ...
                if($data['product_id'] == 0){
                    $data['link_to_zap'] = '/index.php?route=information/information&information_id='.$data['information_id'];
                }elseif($data['information_id'] == 0){
                    $data['link_to_zap'] = '/index.php?route=product/product&product_id='.$data['product_id'];
                }else{
                   $data['link_to_zap'] = ''; 
                }
