  	...
  	public function index() {
		...
		if (isset($this->session->data['guest']['firstname'])) {
			...
			$data['firstname'] = '';
                ...
                if (isset($this->session->data['guest']['fio'])) {
			$data['fio'] = $this->session->data['guest']['fio'];
		} else {
			$data['fio'] = '';
		}
...
//                    var_dump(utf8_strlen($this->request->post['fio']));
                        if ((utf8_strlen($this->request->post['fio']) < 1) || (utf8_strlen($this->request->post['fio']) > 32)) {
                                $json['error']['fio'] = $this->language->get('error_fio');
                        }
		...
		if (!$json) {
			...
			$this->session->data['guest']['lastname'] = $this->request->post['lastname'];
                        $this->session->data['guest']['fio'] = $this->request->post['fio'];
			...
			$this->session->data['payment_address']['firstname'] = $this->request->post['firstname'];
                        $this->session->data['payment_address']['fio'] = $this->request->post['fio'];
			...
			if ($this->session->data['guest']['shipping_address']) {
				$this->session->data['shipping_address']['firstname'] = $this->request->post['firstname'];
                                $this->session->data['shipping_address']['fio'] = $this->request->post['fio'];
